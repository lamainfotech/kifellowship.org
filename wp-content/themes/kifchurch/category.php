        ...
        <?php if(!empty($categories)) { ?>
            <div class="d-flex flex-wrap justify-content-center pb-3">
                <?php foreach($categories as $category) {
                    ...
                    $active_cat = get_cat_ID(single_term_title("", false));
                    
                    if($filter) { ?>
                        <a href="<?php echo $cat_link; ?>" class="btn btn-primary-post-filter <?php if($category->term_id !== $active_cat) { echo 'btn-primary btn-primary--alt'; } ?> mx-1">
